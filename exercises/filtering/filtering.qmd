...
Moses Bol of the Milwaukee Panthers. He played for 289 minutes and his trueshooting percentage is 83.029%.
...
matches_2022 |>
  filter(team == 'Maryland Terrapins, Terps', date < '2022-09-04') |>
  group_by(team) |>
  summarise(
    total_attempts = sum(sh_att),
    total_on_goal = sum(so_g),
...
The percentages between the two years are relatively the same, but Maryland had both fewer total shot attempts and fewer shots on goal. 